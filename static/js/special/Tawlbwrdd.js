...
let king = new PieceInfo('King',['/static/images/King.png'], 0, [new Move([new Vector2(0,1)], 'MoveOnly', false, true, false),new Move([new Vector2(1,0)], 'MoveOnly', false, true, false), new Move([new Vector2(0,-1)], 'MoveOnly', false, true, false),new Move([new Vector2(-1,0)], 'MoveOnly', false, true, false)])
...
function SetupPieces(){
    ...
    blackPieces.push(new Piece(pawn, 0, board[Math.trunc(board.length/2)+1][Math.trunc(board[0].length/2)+1], document.createElement('img')))
    blackPieces.push(new Piece(pawn, 0, board[Math.trunc(board.length/2)-1][Math.trunc(board[0].length/2)+1], document.createElement('img')))
    blackPieces.push(new Piece(pawn, 0, board[Math.trunc(board.length/2)+1][Math.trunc(board[0].length/2)-1], document.createElement('img')))
    blackPieces.push(new Piece(pawn, 0, board[Math.trunc(board.length/2)-1][Math.trunc(board[0].length/2)-1], document.createElement('img')))

    blackPieces.push(new Piece(pawn, 0, board[Math.trunc(board.length/2)+2][Math.trunc(board[0].length/2)], document.createElement('img')))
    blackPieces.push(new Piece(pawn, 0, board[Math.trunc(board.length/2)][Math.trunc(board[0].length/2)+2], document.createElement('img')))
    blackPieces.push(new Piece(pawn, 0, board[Math.trunc(board.length/2)-2][Math.trunc(board[0].length/2)], document.createElement('img')))
    blackPieces.push(new Piece(pawn, 0, board[Math.trunc(board.length/2)][Math.trunc(board[0].length/2)-2], document.createElement('img')))
    blackPieces.push(new Piece(king, 0, board[Math.trunc(board.length/2)][Math.trunc(board[0].length/2)], document.createElement('img')))
    
    //Attack Pieces
    whitePieces.push(new Piece(pawn, 0, board[Math.trunc(board.length/2)-1][0], document.createElement('img')))
    whitePieces.push(new Piece(pawn, 0, board[Math.trunc(board.length/2)+1][0], document.createElement('img')))
    whitePieces.push(new Piece(pawn, 0, board[Math.trunc(board.length/2)][0], document.createElement('img')))
    whitePieces.push(new Piece(pawn, 0, board[Math.trunc(board.length/2)-1][1], document.createElement('img')))
    whitePieces.push(new Piece(pawn, 0, board[Math.trunc(board.length/2)+1][1], document.createElement('img')))
    whitePieces.push(new Piece(pawn, 0, board[Math.trunc(board.length/2)][2], document.createElement('img')))

    whitePieces.push(new Piece(pawn, 0, board[Math.trunc(board.length/2)-1][board[0].length-1], document.createElement('img')))
    whitePieces.push(new Piece(pawn, 0, board[Math.trunc(board.length/2)+1][board[0].length-1], document.createElement('img')))
    whitePieces.push(new Piece(pawn, 0, board[Math.trunc(board.length/2)][board[0].length-1], document.createElement('img')))
    whitePieces.push(new Piece(pawn, 0, board[Math.trunc(board.length/2)-1][board[0].length-2], document.createElement('img')))
    whitePieces.push(new Piece(pawn, 0, board[Math.trunc(board.length/2)+1][board[0].length-2], document.createElement('img')))
    whitePieces.push(new Piece(pawn, 0, board[Math.trunc(board.length/2)][board[0].length-3], document.createElement('img')))

    whitePieces.push(new Piece(pawn, 0, board[0][Math.trunc(board.length/2)-1], document.createElement('img')))
    whitePieces.push(new Piece(pawn, 0, board[0][Math.trunc(board.length/2)+1], document.createElement('img')))
    whitePieces.push(new Piece(pawn, 0, board[0][Math.trunc(board.length/2)], document.createElement('img')))
    whitePieces.push(new Piece(pawn, 0, board[1][Math.trunc(board.length/2)-1], document.createElement('img')))
    whitePieces.push(new Piece(pawn, 0, board[1][Math.trunc(board.length/2)+1], document.createElement('img')))
    whitePieces.push(new Piece(pawn, 0, board[2][Math.trunc(board.length/2)], document.createElement('img')))

    whitePieces.push(new Piece(pawn, 0, board[board[0].length-1][Math.trunc(board.length/2)-1], document.createElement('img')))
    whitePieces.push(new Piece(pawn, 0, board[board[0].length-1][Math.trunc(board.length/2)+1], document.createElement('img')))
    whitePieces.push(new Piece(pawn, 0, board[board[0].length-1][Math.trunc(board.length/2)], document.createElement('img')))
    whitePieces.push(new Piece(pawn, 0, board[board[0].length-2][Math.trunc(board.length/2)-1], document.createElement('img')))
    whitePieces.push(new Piece(pawn, 0, board[board[0].length-2][Math.trunc(board.length/2)+1], document.createElement('img')))
    whitePieces.push(new Piece(pawn, 0, board[board[0].length-3][Math.trunc(board.length/2)], document.createElement('img')))
